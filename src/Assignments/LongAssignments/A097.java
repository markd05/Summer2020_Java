...
Steps to write a program:
   ...
   "Enter your name". Then ask user about ownership of US driver license.
...
If age is between 21 (exclusive) and 25 (exclusive), multiply premium by 2.
	...
	Make sure that experience is grater than 0 and result of subtraction age from experience is greater or equals to 16.
 ...
 If level of education equals to "Less than High School" increase premium by 5%.
 	After all, display message "customer, here's your quote!".
 	Instead of customer, you need yo insert customers name.
 	The display message: "Start Your Policy Today For: $premium".
 	Instead of premium, your program should print premium's variable value.
 	...
 	concatenate first 2 letters of customer's name, age,  last 2 letters of of customer's  name, zip code,
