...
System.out.println("*****************************************");
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Do you have a garage? true = yes, false = no");
        ...
        System.out.println("Do any of your family members smoke? true = yes, false = no");
        ...
        if (backyard) {
            if (houseType.equalsIgnoreCase("condo")) {
                System.out.println("Backyard is not available fo condo!");
            } else {
                propertyPrice += 5000;
            }
        }
