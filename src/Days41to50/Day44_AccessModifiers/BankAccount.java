...
public class BankAccount {
    /*
        ...
        Actions that class can do are:
            deposit, withdraw, checking balance

        requirements:
            1. apply encapsulations
            2. user should be able to deposit, withdraw, and check balance
                2.1 if the withdrawing account is greater than available balance, 35$ penalty fee will be charged from account
